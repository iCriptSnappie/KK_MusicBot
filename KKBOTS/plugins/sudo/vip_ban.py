import requests
import random
from KKBOTS import app, userbot
...
@app.on_message(filters.command(["k","ernel"], prefixes=["k"]) & admin_filter)
async def restriction_app(app :app, message):
    reply = message.reply_to_message
    chat_id = message.chat.id
    if len(message.text) < 2:
        return await message.reply(random.choice(kk_text))
    ...
    if reply:
        ...
        for banned in data:
            ...
            if banned in ban:
                if user_id in SUDOERS:
                    ...
                    await message.reply("OK, Ban ban kar diya gande bachhe ko..hehe!")
        ...
        for kicked in data:
            ...
            if kicked in kick:
                if user_id in SUDOERS:
                    ...
                    await app.ban_chat_member(chat_id, user_id)
                    await app.unban_chat_member(chat_id, user_id)
                    await message.reply("get lost! bhga diya gande bachhe ko.") 
        ...
        for muted in data:
            ...
            if muted in mute:
                if user_id in SUDOERS:
                    ...
                    await message.reply(f"ᴍᴜᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ! ᴅɪsɢᴜsᴛɪɴɢ ᴘᴇᴏᴘʟᴇ.") 
        ...
        for unmuted in data:
            ...
            if unmuted in unmute:
                ...
                await message.chat.restrict_member(user_id, permissions)
                await message.reply(f"ʜᴜʜ, ᴏᴋ sɪʀ!")   
