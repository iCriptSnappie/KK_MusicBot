...
from KKBOTS.misc import HAPP, SUDOERS, XCB
...
@app.on_message(filters.command(["clog", "clogs", "carbonlog", "carbonlogs"], prefixes=PREFIXES) & SUDOERS)
@language
...
@app.on_message(filters.command(["getlog", "logs", "getlogs"], prefixes=PREFIXES) & SUDOERS)
@language
async def log_(client, message, _):
    try:
...
@app.on_message(filters.command(["update", "gitpull"], prefixes=PREFIXES) & SUDOERS)
@language
