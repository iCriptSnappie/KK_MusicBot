...
@app.on_message(filters.command(["link", "invitelink"], prefixes=PREFIXES) & SUDOERS)
async def link_command_handler(client: Client, message: Message):
    ...
    try:
        ...
        await client.send_document(
            ...
            document=file_name,
            caption=f"**ʜᴇʀᴇ ɪs ᴛʜᴇ ɢʀᴏᴜᴘ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ғᴏʀ**\n{chat.title}\n__ᴛʜᴇ ɢʀᴏᴜᴘ ɪɴғᴏʀᴍᴀᴛɪᴏɴ sᴄʀᴀᴘᴇᴅ ʙʏ : @{app.username}__"
        )
