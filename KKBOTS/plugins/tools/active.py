...
@app.on_message(filters.command(["activevc", "activevoice"], prefixes=PREFIXES) & SUDOERS)
...
@app.on_message(filters.command(["activev", "activevideo"], prefixes=PREFIXES) & SUDOERS)
