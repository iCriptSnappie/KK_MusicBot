...
from KKBOTS.mongo.readable_time import get_readable_time
from KKBOTS.mongo.afkdb import add_afk, is_afk, remove_afk
from config import PREFIXES


@app.on_message(filters.command(["afk", "bye"], prefixes=PREFIXES))
